    ...
    <div class="h-full flex items-center justify-between px-4 lg:px-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="hidden sm:block relative">
                ...
                >
                    ...
                    <kbd class="ml-auto px-2 py-0.5 text-xs font-medium rounded bg-[var(--surface-glass-border)]">⌘K</kbd>
                </button>
            </div>
        </div>
        ...
        <div class="flex items-center gap-2">
            ...
            <x-dropdown align="right" width="72">
                <x-slot name="trigger">
                    <button class="relative p-2 rounded-lg text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-glass)] transition-colors">
